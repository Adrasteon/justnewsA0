...
RUNTIME_KEY_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "orchestrator.balance_policy.allow_opinion_as_factual_corroboration": {
        "type": "bool",
        "mutability": "hot",
        "owner": "workflow_orchestrator",
        "apply_mode": "next_tick",
    },
    "orchestrator.discovery.enabled": {
        "type": "bool",
        "mutability": "hot",
        "owner": "workflow_orchestrator",
        "apply_mode": "next_tick",
    },
    "orchestrator.discovery.offsite_follow_enabled": {
        "type": "bool",
        "mutability": "hot",
        "owner": "workflow_orchestrator",
        "apply_mode": "next_tick",
    },
    "orchestrator.discovery.provisional_ingest_enabled": {
        "type": "bool",
        "mutability": "hot",
        "owner": "workflow_orchestrator",
        "apply_mode": "next_tick",
    },
    "orchestrator.discovery.whitelist_only_mode": {
        "type": "bool",
        "mutability": "hot",
        "owner": "workflow_orchestrator",
        "apply_mode": "next_tick",
