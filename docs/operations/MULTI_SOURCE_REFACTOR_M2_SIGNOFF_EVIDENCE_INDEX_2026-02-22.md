...
| Rollback drill proof | Apply/rollback JSON + before/after `owner_overrides` | Commit `89bb1e8` + runbook procedure | Ops | In progress | Env-clearing rollback fix and verification flow documented |
