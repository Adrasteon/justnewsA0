...
variants = [
    ...
    },
    {
        ...
        'system': (
            ...
            'Body requirements: 170-320 words, at least 6 sentences, and substantially longer than summary. '
            'If evidence is limited, still write a full body that explains confirmed facts, uncertainty, and open questions using only provided sources.'
        ),
        'mode': 'strict',
    },
    {
